...
-- =====================================================
-- ПРИМЕЧАНИЕ ПО СОРТИРОВКЕ КЛАССОВ
-- =====================================================
-- Функция FIELD() используется для явного задания порядка классов
-- в соответствии с бизнес-логикой и ожидаемым выводом задания:
-- Sedan → Coupe → Hatchback → Pickup
-- Без FIELD() классы отсортировались бы по алфавиту,
-- что не соответствует ожидаемому результату.