...
-- =====================================================
-- ПРИМЕЧАНИЕ ПО UNION / UNION ALL
-- =====================================================
-- В запросе используется UNION (а не UNION ALL) для гарантии
-- уникальности результата, хотя в текущих данных дубликаты
-- невозможны из-за разных типов транспорта (Car, Motorcycle, Bicycle).
-- Это сделано как defensive programming на случай,
-- если в будущем появятся пересекающиеся наборы данных.